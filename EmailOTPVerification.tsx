...
const EmailOTPVerification: React.FC<EmailOTPVerificationProps> = ({
  ...
  const sendOTP = async () => {
    ...
    try {
      ...
      if (result.success) {
        setMessage('Fresh OTP generated! Check console for the code.');
        setMessageType('success');
        setTimeRemaining(300);
        
        // Show helpful message
        setTimeout(() => {
          setMessage('💡 Check browser console for the OTP code (for testing)');
          setMessageType('info');
        }, 2000);
      } else {
    ...
    <div className="space-y-6">
      <div className="text-center">
        ...
        <p className="text-sm text-blue-600 mt-2">
          💡 Check browser console for the OTP code (for testing)
        </p>
      </div>
